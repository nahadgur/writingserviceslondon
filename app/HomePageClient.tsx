...
import { ArrowRight, Award, MapPin, Shield, Star, Clock, Zap, TreePine, Cloud, Phone } from 'lucide-react';
...
interface Props {
  services: Service[];
  topAreas: string[];
  heroContent: { title: string; subtitle: string; image: string };
  problemFraming: {
    heading: string;
    paragraphs: string[];
  ...
  serviceCardsHeading: { title: string; subtitle: string; linkText: string };
  howItWorks: {
    heading: string;
    subheading: string;
  ...
  regionalContext: {
    heading: string;
    paragraphs: string[];
    regions: { label: string; towns: string; detail: string }[];
  };
  areasSection: { heading: string; subheading: string; browseAllText: string };
  pricingSection: {
    heading: string;
    subheading: string;
    financeHeading: string;
    financeSubheading: string;
  };
  pricingTiers: PricingTier[];
  trustPoints: {
    heading: string;
    subheading: string;
    points: { iconName: string; title: string; desc: string }[];
  };
  homepageFaqs: { question: string; answer: string }[];
  faqSectionTitle: string;
  ctaSection: { heading: string; subheading: string };
}
