...
// metadata for client components doesn't export — handled in
// nearest server file. For a single-purpose contact page we keep
// the page-level title via document.title fallback (Next.js still
// uses the layout default if no metadata is exported here).
