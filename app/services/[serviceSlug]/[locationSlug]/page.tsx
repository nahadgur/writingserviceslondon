...
export default function ServiceLocationPage({ params }: { params: { serviceSlug: string; locationSlug: string } }) {
  ...
  const localBusinessSchema = { '@context': 'https://schema.org', '@type': 'ProfessionalService', name: `${service.title} in ${cityName}`, url: `${siteConfig.url}/services/${service.slug}/${params.locationSlug}/`, description: heroDesc, areaServed: { '@type': 'City', name: cityName, containedInPlace: { '@type': 'AdministrativeArea', name: 'London' } }, serviceType: service.title, priceRange: '\u00a3\u00a3' };
      ...
      <main className="flex-grow">
        ...
        <div className="container-width py-16">
          ...
          <div className="bg-brand-900 rounded-2xl p-8 md:p-12 text-center mt-12">
            ...
            <p className="text-brand-200 mb-8 max-w-2xl mx-auto">Submit your enquiry in under two minutes. We match you with up to three vetted {cityName} will writing specialists with no obligation.</p>
