...
export const blogArticles: BlogArticle[] = [
  ...
  {
    slug: 'care-fees-protecting-your-home-london',
    hub: 'estate-planning-over-50',
    draft: true,
    title: 'Care Home Fees and Protecting Your Family Home in London',
    metaTitle: 'Care Home Fees and Protecting Your Home in London',
    metaDescription: 'How care home fees are means-tested in England, the £23,250 capital limit, why giving away your home rarely works, and how London families can plan ahead.',
    category: 'Estate Planning',
    publishDate: '2026-06-11',
    dateModified: '2026-06-11',
    featuredImage: '/images/estate-planning.png',
    excerpt: 'Care home fees in England are means-tested, and only once your assets fall below £23,250 does the local authority start to help. Your home is often the largest asset in that calculation, but giving it away rarely protects it. For most London families a will-based trust is a safer route.',
    content: [
        {"type": "external-link", "href": "https://www.gov.uk/help-with-care-costs/care-home-fees", "linkText": "GOV.UK: Care home fees and getting help", "text": "GOV.UK sets out how local authorities assess what you pay towards residential care and the current capital limits that apply."},
        {"type": "p", "text": "Care home fees in England are means-tested by your local authority, and the value of your home is often the single largest asset in that calculation. Once your assessed capital falls below £23,250 the council begins to contribute, but above it you pay the full cost yourself. This guide explains how the means test works, when your home is counted, why simply transferring it to your children seldom protects it, and the will-based options London families use instead."},

        {"type": "h2", "text": "How care home fees are means-tested in England"},
        {"type": "p", "text": "A local authority works out what you must pay towards permanent residential care through a financial assessment, usually called the means test. Two capital limits drive the result. If your total assessable capital is above the upper capital limit of £23,250 you are treated as a self-funder and meet the full cost of your care. If it falls below the lower capital limit of £14,250 your capital is left out of the calculation altogether, although you still contribute from income such as pensions. Between those two figures you pay a tariff income of £1 a week for every £250 of capital."},
        {"type": "p", "text": "These thresholds have stayed the same for several years. A reform that would have raised the upper limit to £100,000 and capped lifetime care costs was legislated but never brought into force, and the current government has confirmed it will not introduce it, so the £23,250 and £14,250 limits remain the rules for 2026 to 2027. Because those figures are low relative to London property values, many homeowners in the capital are full-cost payers from the outset once the home is taken into account."},

        {"type": "h2", "text": "When your home is counted in the assessment"},
        {"type": "p", "text": "For someone moving permanently into a care home, the value of their property is usually included as capital, which on its own pushes most London homeowners well above the upper limit. There are important exceptions. The home is disregarded entirely while a spouse or partner still lives there, and the same protection applies where the resident relative is aged over 60, is a child under 16 the resident is responsible for, or is a relative who is disabled or incapacitated. A separate twelve-week property disregard also ignores the home for the first twelve weeks of a permanent stay, giving families some breathing space before the property is brought into the calculation."},
        {"type": "p", "text": "Where no disregard applies, the council may offer a deferred payment agreement, effectively a loan secured against the home so it does not have to be sold during the person's lifetime, with the fees recovered from the estate afterwards. None of this changes the basic position that for a sole owner with no qualifying relative living at the property, the home is normally on the table."},

        {"type": "h2", "text": "Why giving your home away rarely protects it"},
        {"type": "p", "text": "The most common idea families raise is transferring the home to the children to keep it out of the means test. This rarely achieves what people hope. Local authorities can apply the deliberate deprivation of assets rule: if they decide that avoiding care fees was a significant reason for giving an asset away, they can treat you as though you still own it, known as notional capital, and assess you as if the gift had never happened. Crucially there is no fixed seven-year cut-off here. The seven-year period is an inheritance tax rule and does not protect a gift from the care assessment, so even an old transfer can be challenged."},
        {"type": "p", "text": "Outright lifetime gifts carry other risks too. The home becomes legally your children's, exposing it to their divorce, bankruptcy or death, and a gift of a property you carry on living in rent-free can create a separate inheritance tax problem as a gift with reservation of benefit. For these reasons most advisers steer families away from simply signing the house over."},

        {"type": "h2", "text": "How a will can protect a share of the family home"},
        {"type": "p", "text": "For couples who own their home together, a more robust route is a protective property trust, sometimes called a life interest trust, written into each partner's will. The couple first hold the property as tenants in common, each owning a defined share. When the first partner dies, their share passes into the trust rather than to the survivor outright. The survivor keeps a life interest, meaning the right to live in the home for the rest of their life, but does not own the deceased's share. If the survivor later needs residential care, the local authority can assess only the survivor's own share, so the half held in trust can be preserved for the children."},
        {"type": "p", "text": "Because this kind of trust is triggered by death rather than by giving assets away during your lifetime, it does not run into the deliberate deprivation rule in the way a lifetime transfer can. It is not a way to shelter your whole home from your own care costs, and it does nothing for a single owner, but for married couples and civil partners in London it is a widely used and legitimate planning tool. The mechanics, including severing the joint tenancy, need to be set up correctly, which is why this is a job for a qualified professional rather than a homemade will."},
        {"type": "external-link", "href": "https://www.step.org/", "linkText": "STEP (Society of Trust and Estate Practitioners)", "text": "STEP is the professional body for advisers who specialise in trusts, estate planning and care-fee planning."},
        ...
        {"type": "p", "text": "If your assessed capital is above the upper limit of £23,250 you are a self-funder and meet the full cost of your care. Below the lower limit of £14,250 your capital is disregarded, though you still contribute from income such as pensions. Between the two you pay a tariff of £1 a week for every £250 of capital. For most London homeowners the value of the property alone takes them above the upper threshold."},
        {"type": "h3", "text": "Is my house always counted towards care fees?"},
        {"type": "p", "text": "Not always. It is disregarded while a spouse or partner, or a relative who is over 60, disabled or a dependent child, still lives there, and there is a twelve-week disregard at the start of a permanent stay. For a sole owner with no qualifying relative at home the property is usually counted, though a deferred payment agreement can avoid an immediate sale by securing the fees against the home instead."},
        {"type": "h3", "text": "Can I give my house to my children to avoid care fees?"},
        {"type": "p", "text": "It rarely works. If the council decides that avoiding care fees was a significant reason for the gift, it can treat you as still owning the home under the deliberate deprivation rules and assess you accordingly. There is no seven-year safe period for care fees; that limit applies only to inheritance tax. An outright gift can also expose the home to your children's own divorce, bankruptcy or death, so the risks usually outweigh any benefit."},
        {"type": "h3", "text": "Does a property protection trust stop all my care fees?"},
        {"type": "p", "text": "No. A protective property trust in a couple's wills can preserve the share of the first partner to die, because that share passes into trust rather than to the survivor outright. It does not protect the survivor's own share, it does nothing for a sole owner, and it does not avoid fees for the person who actually needs care. It is one tool within a wider plan, not a complete shield, and it must be drafted correctly to work."},
        {"type": "h3", "text": "When should I start care fee planning?"},
        {"type": "p", "text": "Ideally well before care is needed, while you still have full mental capacity and time to put arrangements in place. Care planning sits alongside your will, your lasting powers of attorney and any inheritance tax planning, and steps taken once care is imminent are far more likely to be challenged as deliberate deprivation. A qualified specialist can review your situation and set out realistic options for your circumstances."}
    ]
  },
  {
    slug: 'protecting-a-cohabiting-partner-not-on-the-deeds',
    hub: 'will-for-unmarried-couples',
    draft: true,
    title: 'Protecting a Cohabiting Partner Not on the Property Deeds',
    metaTitle: 'Protect a Partner Not on the Property Deeds',
    metaDescription: 'If you are unmarried and your partner is not on the property deeds, they have no automatic right to your home. How a will and trust can protect them in London.',
    category: 'Estate Planning',
    publishDate: '2026-06-12',
    dateModified: '2026-06-12',
    featuredImage: '/images/estate-planning.png',
    excerpt: 'If your partner is not named on the property deeds and you are not married, they have no automatic right to the home when you die. Without a will the house passes to your blood relatives under intestacy, and your partner can be asked to leave. A will, and often a trust, is the fix.',
    content: [
        {"type": "p", "text": "England and Wales does not recognise common-law marriage, so living together for years gives a partner no automatic stake in a home owned by the other. If you are the sole legal owner and you die without a will, the property passes under the intestacy rules to your blood relatives, not your partner. This guide explains what being on the deeds really means, what happens to the home if there is no will, and the will and trust options that let you protect a partner who is not named on the title."},

        {"type": "h2", "text": "Why an unnamed partner has no automatic claim to the home"},
        {"type": "p", "text": "The idea of the common-law husband or wife is one of the most persistent myths in English law. No matter how long a couple have cohabited, shared the bills, or raised children together, an unmarried partner has no automatic right to inherit when the other dies. The protections that apply to spouses and civil partners simply do not extend to cohabitants. The Law Commission has recommended reform for cohabiting couples more than once, but Parliament has not legislated, so the position in 2026 is unchanged."},
        {"type": "p", "text": "Where one partner is the sole legal owner of the home, the surviving partner is, in strict legal terms, in the same position as anyone else who is not named in a will or recognised by the intestacy rules. They do not step into ownership, and they have no automatic right to remain in the property. That is why being on the deeds, or not, matters so much for couples who are not married."},

        {"type": "h2", "text": "What being on the deeds actually means"},
        {"type": "p", "text": "Legal ownership of a property is recorded at HM Land Registry as the legal title. Two people who own a home together hold it in one of two ways. As joint tenants they own the whole together, and on the first death the survivor takes the entire property automatically by survivorship, outside the will and outside intestacy. As tenants in common they each own a distinct share, often equal but not always, and each share passes under that owner's will or, if there is none, under the intestacy rules."},
        {"type": "p", "text": "A partner who is not on the legal title is not necessarily without any claim. They may have a beneficial interest, a share in the value of the home recognised in equity, if they contributed to the purchase price, the mortgage, or significant improvements, or where there was a common intention that they should share ownership. Establishing a beneficial interest, however, usually means a claim under the Trusts of Land and Appointment of Trustees Act 1996, which is uncertain, stressful, and expensive. It is a remedy of last resort, not a substitute for clear planning."},

        {"type": "h2", "text": "What happens to the home if you die without a will"},
        {"type": "external-link", "href": "https://www.gov.uk/inherits-someone-dies-without-will", "linkText": "GOV.UK: Who can inherit if there is no will", "text": "GOV.UK sets out the order in which relatives inherit under the intestacy rules, which do not include an unmarried partner."},
        {"type": "p", "text": "If you are the sole owner and die without a valid will, the intestacy rules decide who inherits, and a cohabiting partner is not on the list. The estate passes to relatives in a strict order: children and their descendants first, then parents, then siblings, then more distant family. Your partner receives nothing by default, and if a relative inherits the home, your partner can be asked to leave the property they have lived in for years."},
        {"type": "p", "text": "A cohabiting partner who lived with the deceased as a couple for at least two years before the death can apply for reasonable financial provision under the Inheritance (Provision for Family and Dependants) Act 1975. This is a genuine route, but it is litigation: it means going to court, the outcome is not guaranteed, and it can take many months while the partner remains in limbo. Relying on a 1975 Act claim is far weaker than leaving a clear will."},

        {"type": "h2", "text": "How a will can protect a partner who is not on the deeds"},
        {"type": "p", "text": "A will is the most direct way to protect a partner. You can leave the property to them outright, so the home passes to them on your death rather than to your relatives. For many couples that is the simplest answer, but it is not the only option, and it is not always the best one where there are children from a previous relationship to consider."},
        {"type": "p", "text": "A common alternative is a life interest trust, sometimes called a right of occupation. Your will gives your partner the right to live in the home for their lifetime, or for a defined period, after which the property passes to your children or other chosen beneficiaries. This protects your partner without permanently disinheriting your children, which is often the fairest outcome in a blended family. You can also formalise existing shares with a declaration of trust, or add your partner to the legal title as joint tenants or tenants in common, although changing the ownership structure carries its own consequences and should be done with advice."},

        {"type": "h2", "text": "The inheritance tax trap for unmarried partners"},
        {"type": "p", "text": "Tax is where unmarried couples are caught out most sharply. Transfers between spouses and civil partners are exempt from inheritance tax, but that spouse exemption does not apply to cohabiting partners. When you leave assets to a partner you are not married to, the gift counts against your tax-free allowances like any other, and anything above them is taxed at 40 per cent."},
        {"type": "p", "text": "The main tax-free allowance, the nil-rate band, is 325,000 pounds in 2026 to 2027. The additional residence nil-rate band of up to 175,000 pounds applies only where a home passes to direct descendants such as children or grandchildren, so it is generally not available when you leave the home to a partner instead. In London, where a single property often exceeds the nil-rate band on its own, this can leave a surviving partner facing a substantial tax bill on the very home they live in. Specialist advice on trusts, lifetime gifts and life insurance written in trust can reduce that exposure, and these reliefs and figures should always be checked against current HMRC rules for your circumstances."},
        {"type": "external-link", "href": "https://www.willwriters.com/", "linkText": "The Society of Will Writers", "text": "The Society of Will Writers is a self-regulatory body for will-writing professionals in England and Wales."},
        ...
        {"type": "p", "text": "No. England and Wales does not recognise common-law marriage, so a cohabiting partner has no automatic right to inherit. If you are the sole owner and die without a will, the home passes under the intestacy rules to your blood relatives, not your partner. The only reliable way to leave the home to a partner you are not married to is to say so in a valid will."},
        {"type": "h3", "text": "What is the difference between being on the deeds and having a beneficial interest?"},
        {"type": "p", "text": "Being on the deeds means you are a legal owner recorded at HM Land Registry. A beneficial interest is a share in the value of the home recognised in equity, which a partner may have if they contributed to the purchase, the mortgage or major improvements even though they are not named on the title. A beneficial interest can be claimed under the Trusts of Land and Appointment of Trustees Act 1996, but proving it usually requires court proceedings, so it is far less secure than being named as an owner or beneficiary."},
        {"type": "h3", "text": "Can my partner claim the house if I die without a will?"},
        {"type": "p", "text": "Possibly, but only through litigation. A partner who lived with you as a couple for at least two years can apply for reasonable financial provision under the Inheritance (Provision for Family and Dependants) Act 1975. The court has discretion, the outcome is uncertain, and the process can take many months. It is a safety net, not a plan. A will that leaves the home, or a right to occupy it, to your partner avoids the need for any claim."},
        {"type": "h3", "text": "Will my partner pay inheritance tax on a home I leave them?"},
        {"type": "p", "text": "They might. The spouse exemption that removes inheritance tax on gifts between married couples does not apply to cohabiting partners, so a home left to an unmarried partner counts against your nil-rate band of 325,000 pounds, with anything above taxed at 40 per cent. The residence nil-rate band generally does not help, because it applies where a home passes to direct descendants rather than a partner. In London this can produce a real tax bill, and a specialist can advise on ways to reduce it. Always check the current position with HMRC or a qualified adviser."},
        {"type": "h3", "text": "Should I add my partner to the property deeds or leave the home in my will?"},
        {"type": "p", "text": "Both can work, and the right choice depends on your circumstances, especially whether you have children from an earlier relationship. Adding a partner to the title as joint tenants passes the whole property to them automatically on death, while a tenancy in common lets each of you control your own share. A will, particularly one using a life interest trust, can instead give your partner the right to live in the home while preserving it for your children. A qualified specialist can weigh the ownership, tax and family considerations and recommend the structure that fits."}
    ]
  },
  {
    slug: 'which-digital-assets-can-be-inherited',
    hub: 'digital-assets-and-wills',
    draft: true,
    title: 'Which Digital Assets Can Be Inherited in the UK',
    metaTitle: 'Which Digital Assets Can Be Inherited in the UK',
    metaDescription: 'Which digital assets pass to your estate when you die: cryptocurrency, domain names and online balances, versus streaming libraries and licences that cannot be inherited.',
    category: 'Digital Assets',
    publishDate: '2026-06-12',
    dateModified: '2026-06-12',
    featuredImage: '/images/estate-planning.png',
    excerpt: 'Digital assets split into two groups when you die. Things you own, such as cryptocurrency, domain names, PayPal balances and website revenues, form part of your estate and pass under your will. Things you merely licence, such as streaming and ebook libraries, usually end with you and cannot be inherited.',
    content: [
        {"type": "external-link", "href": "https://www.gov.uk/valuing-estate-of-someone-who-died", "linkText": "GOV.UK: Valuing the estate of someone who has died", "text": "GOV.UK requires executors to identify and value everything the deceased owned, which includes digital assets such as cryptoassets and online account balances."},
        {"type": "p", "text": "When you die, your digital life splits into two legal categories. Assets you actually own, such as cryptocurrency, domain names, money in online payment accounts and an income-producing website, form part of your estate and can be left in your will. Content you merely licence, such as a streaming film library or an ebook collection, usually ends with your life and cannot be passed on at all. This guide explains which side of the line common digital holdings fall on, where the grey areas sit, and how to deal with each group when you plan your estate."},

        {"type": "h2", "text": "The test that decides it: ownership or licence"},
        {"type": "p", "text": "The question that settles almost every case is whether you own the thing itself or only hold a personal right to use it. Property you own passes to your estate on death, in the same way as a house or a bank account, and your executor collects it in and distributes it under your will. A licence, by contrast, is a contractual permission granted to you personally by a provider, and most consumer terms of service state that the permission is non-transferable and ends on death."},
        {"type": "p", "text": "This is why two collections that feel identical can have opposite outcomes. A folder of photographs you took belongs to you, including the copyright in them, and passes to your estate. A library of films bought through a streaming platform was never yours in that sense; you paid for personal access, and the access dies with the account. The price paid is irrelevant. What matters is what the terms of service actually granted."},

        {"type": "h2", "text": "Digital assets that do form part of your estate"},
        {"type": "p", "text": "A useful starting point is anything with realisable value that is registered or held in your name. These pass under your will, and if there is no will they pass under the intestacy rules like any other property."},
        {"type": "list", "items": [
            "Cryptocurrency and other cryptoassets: HMRC treats cryptoassets as property for tax purposes, so holdings such as Bitcoin form part of the estate, count towards inheritance tax, and pass to beneficiaries under the will.",
            "Money in online accounts: PayPal balances, online-only bank and savings accounts, investment and trading platform holdings, and unwithdrawn balances in selling accounts all belong to the estate.",
            "Domain names and websites: a registered domain can be transferred to a beneficiary, and a website or online business that produces income is an estate asset in the same way as any other business interest.",
            "Intellectual property you created: copyright in your own photographs, writing, music, designs and code survives your death and can be left in your will, often lasting decades beyond it.",
            "Monetised channels and digital business assets: advertising revenue streams, affiliate accounts and similar income rights connected to content you own are capable of passing to the estate, subject to each platform agreeing the transfer mechanics."
        ]},
        {"type": "p", "text": "For these assets the practical challenge is rarely the legal right but the discovery and access. An executor cannot collect a crypto wallet nobody knows exists, and a recovery phrase that died with the owner can make the asset permanently unreachable, even though it legally belongs to the estate."},

        {"type": "h2", "text": "Digital purchases that usually cannot be inherited"},
        {"type": "p", "text": "The second group is licensed content, and it catches many families by surprise. Streaming video and music libraries, ebook and audiobook collections, downloaded apps and most in-app purchases are typically supplied under personal, non-transferable licences. When the account holder dies, the licence terminates and the provider is generally under no obligation to transfer the collection to anyone else, no matter how much was spent building it."},
        {"type": "p", "text": "Subscription services follow the same pattern. A subscription is a contract for ongoing personal service, so it ends on death, and the executor's job is simply to cancel it and stop further payments leaving the estate. Game libraries and virtual items inside games sit at the restrictive end of the spectrum, since most platform terms prohibit account transfers entirely. None of this stops a family keeping a shared device signed in, but that is informal tolerance by the provider, not an inherited right, and it can be withdrawn."},

        {"type": "h2", "text": "The grey areas: loyalty points, email and photo libraries"},
        {"type": "p", "text": "Between clear property and clear licence sits a middle band where the outcome depends on each provider's scheme rules. Airline miles, hotel points and retail loyalty balances are contractual rights, and schemes differ: some allow transfer to a spouse or family member on death, often on production of a death certificate, while others state that points lapse. They are worth checking, because large balances can have real value, but they cannot be assumed to pass under a will."},
        {"type": "p", "text": "Email accounts and cloud photo libraries are a different kind of grey. The account itself is a licence and is not inherited, but the contents may include material that matters enormously, from family photographs you took, which carry your copyright, to documents the executor needs to administer the estate. Providers handle this through their own bereavement and legacy processes rather than through the will, so the realistic goal is access to the contents rather than transfer of the account itself."},
        ...
        {"type": "p", "text": "Yes. HMRC treats cryptoassets as property, so holdings such as Bitcoin form part of your estate, count towards any inheritance tax calculation, and pass to your beneficiaries under your will or the intestacy rules. The practical risk is access rather than law: if your executor cannot find the wallet or the recovery phrase, the asset may be unrecoverable even though the estate legally owns it, so secure access planning matters as much as the will."},
        {"type": "h3", "text": "Can I leave my streaming or ebook library to someone in my will?"},
        {"type": "p", "text": "Usually not. Streaming films, music, ebooks and most app purchases are supplied under personal licences that end on death and are non-transferable under the provider's terms of service. You paid for access rather than ownership, so the collection is not part of your estate and a gift of it in a will has nothing to attach to. If preserving content matters to you, favour formats you genuinely own, such as your own photographs or purchased files free of such restrictions."},
        {"type": "h3", "text": "What happens to airline miles and loyalty points when someone dies?"},
        {"type": "p", "text": "It depends entirely on the scheme rules. Some airlines and hotel programmes allow points to be transferred to a spouse or family member on death, usually on production of a death certificate, while other schemes state that balances simply lapse. Points are contractual rights rather than property, so they do not automatically pass under a will. Executors should check each scheme directly, because large balances can be worth claiming where the rules allow it."},
        {"type": "h3", "text": "Do digital assets count for inheritance tax?"},
        {"type": "p", "text": "Assets with real value do. GOV.UK guidance on valuing an estate requires executors to include everything the deceased owned, and that covers cryptoassets, online account balances, domain names and online business interests at their open market value. Licensed content with no transferable value, such as a streaming library, has nothing to bring into the estate. Valuing cryptoassets and online businesses can be technical, so executors often need advice from a qualified professional."},
        {"type": "h3", "text": "Should I list my digital assets and passwords in my will?"},
        {"type": "p", "text": "List the assets, never the passwords. A will can refer to your digital assets and say who should receive them, but it becomes a public document once probate is granted, so credentials, PINs and recovery phrases must not appear in it. Keep a separate, secure and current record of accounts and access arrangements, for example in a password manager with an emergency access feature, and make sure your executor knows the record exists and how to reach it when needed."}
    ]
  },
  {
    slug: 'property-protection-trust-wills-london',
    hub: 'trust-planning-guide',
    draft: true,
    title: 'Property Protection Trusts in Wills for London Couples',
    metaTitle: 'Property Protection Trusts in Wills for London Couples',
    metaDescription: 'How a property protection trust in a will works for London couples: severing a joint tenancy, the life interest for the survivor, and what it can and cannot protect.',
    category: 'Trust Planning',
    publishDate: '2026-06-13',
    dateModified: '2026-06-13',
    featuredImage: '/images/trust-planning.png',
    excerpt: 'A property protection trust is a clause in each partner\'s will that puts the first person\'s share of the home into trust when they die. The survivor keeps the right to live there for life, while the capital in that share is preserved for the children, whatever happens later.',
    content: [
        {"type": "external-link", "href": "https://www.gov.uk/joint-property-ownership", "linkText": "GOV.UK: Joint property ownership", "text": "GOV.UK explains the difference between joint tenants and tenants in common, and how to sever a joint tenancy so each owner holds a distinct share that can pass under a will."},
        {"type": "p", "text": "Most London couples own their home as joint tenants, which means the whole property passes automatically to the survivor when the first of them dies. That is simple, but it leaves everything exposed to whatever happens in the survivor's later life: remarriage, a new will, or a care fee assessment. A property protection trust changes that. Each partner's will leaves their own share of the home into a trust on the first death, so the survivor can stay in the home for the rest of their life while the capital in that share is ring-fenced for the children. This guide explains how the arrangement is set up, what it protects against, and where its limits sit."},

        {"type": "h2", "text": "What a property protection trust actually is"},
        {"type": "p", "text": "A property protection trust, sometimes called a protective property trust or life interest trust of the home, is not a separate document. It is a set of clauses written into each partner's will. On the first death, the deceased partner's share of the home does not pass outright to the survivor. Instead it passes to trustees, who hold it on terms that give the survivor a life interest: the right to live in the property, or to move and have the trust share reinvested in a replacement home, for as long as they live. When the survivor dies, the trust share passes to the final beneficiaries named in the first will, usually the couple's children."},
        {"type": "p", "text": "The survivor's own half of the home is untouched by all of this. They continue to own it absolutely and can leave it however they choose in their own will. The trust only governs the share that belonged to the person who died first, which is precisely why the arrangement works: everyone is free to decide what happens to their own property, and that decision is locked in at the first death rather than left open for decades."},

        {"type": "h2", "text": "Step one: severing the joint tenancy"},
        {"type": "p", "text": "The trust can only work if each partner actually has a share to leave. Joint tenants do not own shares; they own the whole together, and the survivorship rule passes the property outside the will entirely. So the first practical step is to sever the joint tenancy and become tenants in common, usually in equal shares. This is done by serving a written notice of severance and registering the change with HM Land Registry, which places a standard restriction on the title. Severance does not change who lives in the home, what the mortgage looks like or how the couple use the property day to day. It simply means each partner now owns a distinct half that their will can direct."},
        {"type": "p", "text": "London adds one practical wrinkle: many couples here hold property in unequal shares because one partner brought more to the purchase, often recorded in a declaration of trust. A property protection trust can sit alongside unequal shares without difficulty, but the will drafter needs to know the true ownership position before drafting, which is one reason a proper fact-find matters more than a template."},

        {"type": "h2", "text": "What the trust protects against"},
        {"type": "p", "text": "The first risk it addresses is sideways disinheritance. Under section 18 of the Wills Act 1837, marriage revokes an existing will, so if a surviving partner remarries and never makes a new will, the intestacy rules favour the new spouse and the children of the first marriage can lose out badly. With a property protection trust, half the home is already outside the survivor's estate and committed to the children, whatever the survivor's later wills or marriages say."},
        {"type": "p", "text": "The second risk is care fees on the survivor. If the survivor later needs residential care, the local authority means test looks at the survivor's own assets. The trust share belongs to the first partner's trust, not to the survivor, so it is not the survivor's asset to assess. With London property values, the difference between the whole home and half the home being available to a means test can be several hundred thousand pounds. The arrangement is generally respected because the first partner was always free to leave their own share away from the survivor; it is not the survivor giving anything away."},

        {"type": "h2", "text": "What it cannot do"},
        {"type": "p", "text": "It is worth being clear about the limits, because this is an area where overclaiming causes real harm. A property protection trust does nothing for the first partner's care fees, since the trust only comes into existence on the first death. It cannot protect the survivor's own half of the home from a means test on the survivor. And it is not a device for a couple to shelter the whole property while both are alive; lifetime transfers made with care fees in mind risk being treated as deliberate deprivation of assets and assessed as if the owner still held them. The honest summary is that the trust protects one half of the home, against risks that arise after the first death, and that is exactly what it is designed to do."},
        ...
        {"type": "p", "text": "No. The whole point of the life interest is that the survivor has a legal right to live in the property for the rest of their life, and properly drafted wills also let them downsize or move, with the trust share carried into the replacement property. The children, as final beneficiaries, cannot demand their inheritance early or force a sale while the survivor is alive. Their interest only takes effect when the survivor dies or gives up the occupation rights voluntarily."},
        {"type": "h3", "text": "Do we have to change how we own our house first?"},
        {"type": "p", "text": "Usually yes. If you own as joint tenants, the survivorship rule passes the whole home to the survivor automatically and your will never gets the chance to direct your share. Severing the joint tenancy so you hold as tenants in common gives each of you a distinct share your will can put into trust. Severance is a routine step involving a written notice and a Land Registry restriction, and it changes nothing about your day-to-day occupation or your mortgage."},
        {"type": "h3", "text": "Will the trust protect our home if I need care before my partner dies?"},
        {"type": "p", "text": "No. The trust only comes into existence on the first death, so it offers no protection while both of you are alive. If you need residential care first, your share of the home is your asset and can be counted in the means test, although the home is disregarded while your partner still lives there. Anyone who tells you a will trust shields the whole home for both partners in all circumstances is overselling it, and that is a reason to seek advice elsewhere."},
        {"type": "h3", "text": "What happens if my surviving partner remarries?"},
        {"type": "p", "text": "The trust share is unaffected. Marriage revokes the survivor's existing will under the Wills Act 1837, and a new spouse gains strong rights over the survivor's own estate, but the first partner's share of the home already sits in the trust and is committed to the final beneficiaries named in the first will. That is the sideways disinheritance protection in action: the survivor's later choices, or the intestacy rules, can only ever reach the survivor's own half."},
        {"type": "h3", "text": "Is a property protection trust worth it for unequal shares or higher value homes?"},
        {"type": "p", "text": "Often, yes, but the drafting needs to reflect reality. Couples who own in unequal shares, perhaps recorded in a declaration of trust from the purchase, can still use the arrangement; the will simply directs whatever share the first partner actually owns. On higher value London homes the inheritance tax position should be reviewed at the same time, since the residence nil-rate band tapers away for estates above two million pounds. A qualified professional should look at the whole picture rather than the trust in isolation."}
    ]
  },
  {
    slug: 'shareholder-agreements-and-your-will',
    hub: 'business-owner-wills',
    draft: true,
    title: 'Shareholder Agreements and Your Will',
    metaTitle: 'Shareholder Agreements and Your Will in London',
    metaDescription: 'How to align your will with a shareholder or partnership agreement, why cross-option agreements matter, and how to protect business relief when shares pass on death.',
    category: 'Estate Planning',
    publishDate: '2026-06-13',
    dateModified: '2026-06-13',
    featuredImage: '/images/estate-planning.png',
    excerpt: 'If you own company shares or a partnership stake, your will is only half the plan. The other half is your shareholder or partnership agreement. When the two are not read together, your shares can pass somewhere you never intended and valuable tax relief can be lost. Here is how a London business owner makes them work as one.',
    content: [
        {"type": "external-link", "href": "https://www.gov.uk/business-relief-inheritance-tax", "linkText": "GOV.UK: Business Relief for Inheritance Tax", "text": "GOV.UK sets out which business assets qualify for Business Relief and the conditions that must be met for relief at 100 per cent or 50 per cent."},
        {"type": "p", "text": "If you own company shares or a partnership stake, a will alone does not control what happens to your business when you die. The company's own documents do much of the work, and they sit above your will for the shares themselves. When the will and the business agreement are drafted in isolation, they can pull in different directions: shares promised to your family in the will, but compelled into someone else's hands by the company's rules. This guide explains how a shareholder or partnership agreement interacts with your will, where cross-option agreements fit, and how to keep your Business Relief intact in the process. It assumes you are making a will rather than asking what happens if you do not, which is covered in our hub on [wills for business owners](/guides/business-owner-wills/)."},

        {"type": "h2", "text": "Your will and your shareholder agreement do different jobs"},
        {"type": "p", "text": "A will directs your estate: who inherits, who acts as executor, and how your personal and family assets are shared. A shareholder agreement, together with the company's articles of association, governs the shares as a class of property in their own right. For a partnership, the partnership deed plays the equivalent role. These business documents commonly contain pre-emption rights, transmission provisions and compulsory transfer clauses that decide what happens to an owner's interest on death, and they generally take priority over whatever the will says about those shares."},
        {"type": "p", "text": "The practical effect surprises many owners. You can leave your shares to your children in your will, but if the articles give the surviving shareholders a pre-emption right to buy them first, your children may receive only the value of the shares in cash rather than the shares and the control that go with them. The will is not wrong; it is simply working on an asset the company's rules have already spoken for. The two documents have to be read together for either to do what you want."},

        {"type": "h2", "text": "Where the two documents collide"},
        {"type": "p", "text": "Conflicts usually surface in one of a few ways. The most common is a will that gifts shares the agreement does not actually allow to pass freely, so the gift fails or is converted into a right to proceeds. Another is a binding obligation in the agreement that forces a sale the family did not expect. A third is silence: no shareholder agreement at all, leaving the articles and the general law to decide, often with results no one intended."},
        {"type": "list", "items": [
            "Pre-emption rights: surviving shareholders may have the first right to buy the deceased's shares, so a gift in the will of the shares themselves cannot take effect as written.",
            "Compulsory transfer clauses: the articles may require shares to be offered to existing members on death, sometimes at a formula price that differs from market value.",
            "Partnership deeds: most deeds set out what happens to a partner's share on death, including whether the surviving partners must buy it and how it is valued, overriding a contrary gift in the will.",
            "No agreement at all: without clear provisions, a death can freeze voting rights, stall decisions and leave co-owners and the family in dispute over an asset nobody can cleanly transfer."
        ]},

        {"type": "h2", "text": "Cross-option agreements, the usual solution"},
        {"type": "p", "text": "The arrangement that reconciles all of this for most owner-managed businesses is a cross-option agreement, sometimes called a double option agreement. Each surviving owner is given an option to buy the deceased's share, and the deceased's estate is given an option to sell it. If either side exercises its option, the other must complete the deal, which is typically funded by life policies written in trust so the cash is available when needed. The result is that the family receives fair value promptly and the surviving owners keep control of the business, with the will free to direct the proceeds rather than the shares."},
        {"type": "p", "text": "The reason it is a cross-option rather than a straightforward buy and sell agreement is a tax one, and it matters enough to get right. A qualified professional should confirm the structure for your company, because the difference between an option and a binding obligation is the difference between keeping and losing a major relief."},

        {"type": "h2", "text": "Protecting Business Relief when shares pass on death"},
        {"type": "p", "text": "Business Relief can reduce the inheritance tax on a qualifying trading business or unquoted shares, and it is often what allows a family to keep the business rather than sell it to pay a tax bill. From 6 April 2026, 100 per cent relief is limited to the first £1 million of combined qualifying business and agricultural assets, with the rate above that allowance reduced to 50 per cent. Relief also generally requires the assets to have been held for at least two years and to still qualify at the date of death. These rules are complex and subject to change, so an owner with a significant interest should take advice rather than assume relief applies."},
        {"type": "p", "text": "The trap is the binding buy and sell agreement. Where the agreement obliges the estate to sell and the survivors to buy on death, HMRC treats the interest as subject to a binding contract for sale at the date of death, which converts it into a right to cash proceeds and can deny Business Relief on those shares. A cross-option agreement avoids this, because neither side is obliged to act unless an option is exercised, so there is no binding contract for sale in place at death and the relief is preserved. Because the planning sits on the boundary between the will, the company documents and inheritance tax, our [estate planning review service](/services/estate-planning/) connects business owners with specialists who consider all three together, and where relief is in question the [inheritance tax calculator](/tools/iht-calculator/) is a useful first sense-check of the exposure."},
        ...
        {"type": "p", "text": "Generally no, not for the shares themselves. The company's articles of association and any shareholder agreement govern how shares pass on death, and they usually take priority over a gift in your will. If those documents contain pre-emption rights or compulsory transfer clauses, your will cannot simply pass the shares to a chosen beneficiary against them. The will and the agreement need to be drafted to say the same thing, which is why a specialist reviews both together."},
        {"type": "h3", "text": "What is a cross-option agreement and why use one?"},
        {"type": "p", "text": "A cross-option agreement gives the surviving owners an option to buy a deceased owner's share and the estate an option to sell it, usually funded by life insurance written in trust. If either side exercises its option the other must complete, so the family receives fair value and the survivors keep control. It is preferred over a binding buy and sell obligation because it avoids creating a contract for sale at death, which protects Business Relief. A qualified adviser should tailor it to your company."},
  ...
  },
  {
    ...
    content: [
        ...
        {"type": "h2", "text": "Frequently Asked Questions"},
        {"type": "h3", "text": "Can my family get an LPA if I have already lost capacity?"},
        {"type": "p", "text": "No. A lasting power of attorney can only be made while you still have the mental capacity to understand and sign it. Once capacity has been lost, that route is closed and the only way for a relative to gain authority over your finances or care is to apply to the Court of Protection to be appointed as a deputy. This is why an LPA has to be arranged in advance, well before there is any sign it will be needed."},
        {"type": "h3", "text": "Is deputyship more expensive than an LPA?"},
        {"type": "p", "text": "Yes, and by a wide margin. Registering an LPA is a one-off fee of £92 per document plus modest professional costs. A deputyship application carries a court fee of £421, a £100 assessment fee for a new deputy, then ongoing annual supervision fees, a possible security bond and professional charges. Because the supervision fee recurs every year, deputyship also keeps costing long after the LPA would have been a single settled expense."},
        {"type": "h3", "text": "How long does each one take to put in place?"},
        {"type": "p", "text": "An LPA currently takes roughly eight to ten weeks to register when the application is filled in correctly, and it can be set up long before it is needed so the delay is never a problem. Deputyship is applied for only after capacity is lost, and it commonly takes around four to six months, longer if the case is complex or contested. That difference matters most in an emergency, when a deputyship application leaves the family without authority for months."},
        {"type": "h3", "text": "Do I need both types of LPA?"},
        {"type": "p", "text": "Most people should have both. A property and financial affairs LPA lets your attorneys manage money, bills and property; a health and welfare LPA lets them make decisions about medical treatment and care. A financial attorney cannot make health decisions and vice versa, so a single document leaves a gap. Preparing both together is usually more cost-effective than doing them separately and closes that gap in one step."},
